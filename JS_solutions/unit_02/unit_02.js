...
function t12() {
    ...
    let wrapper12 = document.querySelector('.out-12');
    wrapper12.innerHTML = 'Hello ' + firstName.value + ' ' + lastName.value;
}
...
function t13() {
    ...
    let wrapper13 = document.querySelector('.out-13');
    wrapper13.innerHTML = a + b;
}
...
function t16() {
    ...
    document.querySelector('.out-16').innerHTML = a16 + b16; //Не стал переводить полученное из input в число 
}
...
function t19() {
    let iFirst = document.querySelector('.i-19-1');
    let iSecond = document.querySelector('.i-19-2');
    document.querySelector('.out-19').innerHTML = parseFloat(iFirst.value) + parseFloat(iSecond.value);
}
