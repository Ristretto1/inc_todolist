...
function f6() {
    let pars = document.querySelectorAll('.p-6');
    document.querySelector('.out-6').innerHTML = pars.length;
}
...
function f18() {
    ...
    let par = document.querySelector('.p-18');

    out.innerHTML = par.getAttribute('data-b');
}
