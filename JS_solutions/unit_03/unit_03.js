...
function f3() {
   let value1 = +document.querySelector('.i-31').value;
   let value2 = +document.querySelector('.i-32').value;
   let out = document.querySelector('.out-3');

   if (value1 > value2) {
      out.innerHTML = value1;
   } else {
      out.innerHTML = value2;
   }
}
...
function f7() {
   let value1 = +document.querySelector('.i-71').value;
   let value2 = +document.querySelector('.i-72').value;
   let out = document.querySelector('.out-7');

   out.innerHTML = value1 ** value2;
}
...
function f14() {
   let value1 = +document.querySelector('.i-141').value;
   let value2 = +document.querySelector('.i-142').value;
   let value3 = document.querySelector('.s-143').value;
...
function f15() {
   let value1 = document.querySelector('.s-151').value;
   let value2 = document.querySelector('.s-152').value;
   let value3 = document.querySelector('.s-153').value;
