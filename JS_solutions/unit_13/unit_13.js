...
function f6() {
    let keyValue = document.querySelector('.i-61').value;
    let dataValue = document.querySelector('.i-62').value;

    a6[keyValue] = dataValue;
...
function f7() {
    let keyValue = document.querySelector('.i-7').value;
    let out = document.querySelector('.out-7');

    if (a7[keyValue] !== undefined) {
        out.innerHTML = 1;
    } else {
        out.innerHTML = 0;
    }
...
function f8() {
    let keyValue = document.querySelector('.i-8').value;
    let out = document.querySelector('.out-8');

    if (a8[keyValue] !== undefined) {
        out.innerHTML = a8[keyValue];
    } else {
        out.innerHTML = 0;
    }
}
...
function f9() {
    let value9 = document.querySelector('.i-9').value;
    let out = '';
