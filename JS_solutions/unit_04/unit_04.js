...
function f7() {
    let passwowrd = document.querySelector('.out-71');
    let validator = document.querySelector('.out-72');
    let input = document.querySelector('.i-7');

    passwowrd.innerHTML = input.value;
    if (input.value.length >= 6) {
        validator.innerHTML = 1;
    } else {
        validator.innerHTML = 0;
    }
}
