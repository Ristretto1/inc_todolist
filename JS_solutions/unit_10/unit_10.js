...
let ar1 = ['Кирилл', 28, true]; // переменную обьявляем здесь!!!!
...
let ar2 = ['Кирилл', 28, true]; // переменную обьявляем здесь!!!!
...
let ar3 = ['Кирилл', 28, true, 88, false]; // переменную обьявляем здесь!!!!
...
let ar4 = [0, 38, 1, 2, 3, 5, 6, 8, 9]; // переменную обьявляем эту здесь!!!!
...
let ar6 = ['Кирилл', 'близнецы', 22, 'май'];
